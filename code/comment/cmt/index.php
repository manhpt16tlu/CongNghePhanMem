...
<head>
    ...
    <link rel="stylesheet" href="assets\css\cmt.css">
...
<!--enctype="multipart/form-data"  -->
    ...
    <div class="container">
        ...
        // 
        echo "<br>";
        $sql='select tai_khoan.email,binhluansp.id_Bl,binhluansp.id_tk,binhluansp.id_sp,binhluansp.sosao,binhluansp.hinhanh,binhluansp.ND,binhluansp.ngaybinhluan from binhluansp,tai_khoan where binhluansp.id_tk=tai_khoan.id_tk and binhluansp.id_sp = '.$_GET['id_sp'].'';
            ...
            foreach($listcomment as $listcm){
                ...
                echo '<div class="element_bl"><a href="img.php?id_tk='.$listcm["id_tk"].'&id_sp='.$listcm["id_sp"].'&id_Bl='.$listcm["id_Bl"].'"><img style="width: 100px; height: 100px;filter: drop-shadow(0 0 5px white);" src="img/'.$listcm['hinhanh'].'"></a></div><br><br>'; 
