...
<div class="info">
 ...
 <form action="success.php" method = "POST">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="diachi" placeholder="Nhập địa chỉ" required>
...
for(i = 0;i < display_cart.length;i++)
{
  display_cart[i].style.display = 'none';
   ...
   echo "<span class='content first'>Đơn hàng của bạn gồm có</span>";
   $sl = "";
   foreach($_SESSION['cart'] as $keys => $values)
   {
     if($str[0] == "0")
   ...
   echo "<span class='content'> Tổng tiền là: ".$_POST['tong']."</span>";
