...
if(isset($_GET['create']) ){
    include('createfb.php');
}
    
if(isset($_GET['update']) )
    include('updatefb.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="asset\css\cmanager.css">
    ...
    <div id="container_cm">
        ...
        echo ' 
                ...
                echo'<td><a class="a create" href="feebback.php?id_Bl='.$lph['id_Bl'].'&create=true">Thêm phản hồi</a></td>    
                    ...
                    <td><a class="a delete" href="deletefb.php?id_Bl='.$lph['id_Bl'].'" onclick="notificationdelete()"> Xóa phản hồi</a></td>
