...
<div id="product">
            ...
            <ul class="category-list">
                ...
                <?php
                    ...
                    while($row = $result->fetch_assoc()) {
                        echo ' 
                            <li class="category-item"><a href="san_pham.php?danhmucsp='.$row['id_Nsp'].'"><i class="fas fa-angle-right category-item-icon"></i>'.$row['name_Nsp'].'</a></li>
                            ';
                    }
                ?>
        ...
        <div class="product-list c-10">
            <div class="row">
                <?php
                    include 'connect.php';
                    $sql = 'select * from sanpham where id_Nsp = '.$_GET["danhmucsp"].'  ';
                    $result = $conn->query($sql);
                                ...
                                <div class="product-item">
                                    <a href="">
                                        ...
                                        <div class="product-item-price">
                                            ...
                                            <div class="product-item-seen">Số lượng tồn '.$row['soluong_ton'].'</div>
